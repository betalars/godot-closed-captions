...
func _enter_tree():
	...
	add_custom_type("CaptionSequenceAudioStream", "CaptionedAudioStream", preload("res://addons/closed_captions/caption_sequence_audio_stream.gd"), preload("icons/CaptionSequenceAudioStream.svg"))
